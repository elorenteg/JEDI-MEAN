...
angular.module('LibrosApp').controller('createTareaDialogController',
...
angular.module('LibrosApp').controller('TareasCtrl', ['$scope', 'TareasService', 'ToastService', '$mdDialog', TareasCtrl]);
