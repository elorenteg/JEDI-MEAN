...
angular.module('LibrosApp').factory('authInterceptor', ['$q', '$window', '$injector', function ($q, $window, $injector) {
    return {
...
angular.module('LibrosApp').config(['$httpProvider', function ($httpProvider) {
